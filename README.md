...
```
cd existing_repo
git remote add origin https://gitlab.com/cicd4930718/docker_hub.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/cicd4930718/docker_hub/-/settings/integrations)
